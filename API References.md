...
* DELETE /api/families/members/:fmId — Remove family member
...
* GET /api/auth/me (Requires Auth) — Get current logged-in user
...
* DELETE /api/medications/members/:fmmId — Remove family member medication
Schedules
