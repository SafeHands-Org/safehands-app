...
class ScheduleFormView extends ConsumerStatefulWidget {
  const ScheduleFormView({super.key, required this.member});
          ...
          children: [
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  ActionChip(
                    ...
                    label: Text('Add Time', style: TextStyle(fontSize: 13, color: cs.primary)),
              ...
              child: Wrap(
                ...
                children: _days.map((day) {
                  ...
                  return FilterChip(
                    ...
                    side: BorderSide(
                      color: isSelected ? cs.primary.withValues(alpha: 0.3) : cs.outlineVariant,
                    ),
                    backgroundColor: cs.surface,
                    showCheckmark: false,
                  );
            ...
            FormSection(
              ...
              child: EditableFormField(
                ctrl: _repeatInterval,
                validators: (v) => v == null ? 'Please select a frequency' : null,
                hintText: 'Enter the frequency in days'
              )
            ),
          ],
        ),
